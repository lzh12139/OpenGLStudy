...
set(command "D:/Program Files/CMake/bin/cmake.exe;-DCMAKE_BUILD_TYPE=;-Dgtest_force_shared_crt=ON;-Dgtest_disable_pthreads:BOOL=OFF;-DBUILD_GTEST=ON;-DCMAKE_ARCHIVE_OUTPUT_DIRECTORY_DEBUG:PATH=DebugLibs;-DCMAKE_ARCHIVE_OUTPUT_DIRECTORY_RELEASE:PATH=ReleaseLibs;-GVisual Studio 16 2019;-DCMAKE_GENERATOR_INSTANCE:INTERNAL=d:/Program Files (x86)/Microsoft Visual Studio/2019/Community;C:/Users/HP/Desktop/dev-cpp/openGL/assimp-3.3.1/assimp-3.3.1/test/gtest/src/gtest")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "C:/Users/HP/Desktop/dev-cpp/openGL/assimp-3.3.1/assimp-3.3.1/test/gtest/src/gtest-stamp/gtest-configure-out.log")
set(stderr_log "C:/Users/HP/Desktop/dev-cpp/openGL/assimp-3.3.1/assimp-3.3.1/test/gtest/src/gtest-stamp/gtest-configure-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  C:/Users/HP/Desktop/dev-cpp/openGL/assimp-3.3.1/assimp-3.3.1/test/gtest/src/gtest-stamp/gtest-configure-*.log")
  endif()
  ...
  set(msg "gtest configure command succeeded.  See also C:/Users/HP/Desktop/dev-cpp/openGL/assimp-3.3.1/assimp-3.3.1/test/gtest/src/gtest-stamp/gtest-configure-*.log")
  message(STATUS "${msg}")
endif()
